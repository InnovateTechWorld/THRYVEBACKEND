...
exports.createCreditCheckMiddleware = createCreditCheckMiddleware;
exports.registerCreditCheckMiddleware = registerCreditCheckMiddleware;
...
function createCreditCheckMiddleware(options) {
    ...
    return async function creditCheckMiddleware(request, reply) {
        ...
        try {
            ...
            else if (request.exportedApiData?.user_id) {
                userId = request.exportedApiData.user_id;
            }
            else {
            ...
            const creditCheckResponse = await openRouterManager.checkUserCredits(userId, requiredCredits, supabase, request.log, modelId // ✅ Pass model ID to credit check
            );
...
function registerCreditCheckMiddleware(fastify, options) {
