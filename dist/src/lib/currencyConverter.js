...
exports.CurrencyConverter = exports.CURRENCY_RATES = void 0;
...
class CurrencyConverter {
    ...
    static convert(amount, fromCurrency, toCurrency) {
        const from = exports.CURRENCY_RATES[fromCurrency.toUpperCase()];
        const to = exports.CURRENCY_RATES[toCurrency.toUpperCase()];
        if (!from || !to) {
     ...
     */
    static toUSD(amount, fromCurrency) {
        return this.convert(amount, fromCurrency, 'USD');
    }
    /**
     * Convert USD to any currency
     */
    static fromUSD(amount, toCurrency) {
        return this.convert(amount, 'USD', toCurrency);
    }
    /**
     * Get supported payment methods for a currency
     */
    static getSupportedPaymentMethods(currency) {
        const currencyData = exports.CURRENCY_RATES[currency.toUpperCase()];
        if (!currencyData) {
    ...
    static isSupported(currency) {
        return currency.toUpperCase() in exports.CURRENCY_RATES;
    }
    /**
     * Get currency symbol
     */
    ...
    static getSupportedCurrencies() {
        return Object.values(exports.CURRENCY_RATES);
    }
    /**
     ...
     */
    static calculatePlatformFee(amount, currency, feePercentage = 0.15) {
